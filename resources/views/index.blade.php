    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Escuela de Aviación</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">Cursos</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">Extranjeros</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">Estudiantes</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">Novedades</a></li>
        ...
        <header class="masthead text-white text-center bg-image">
            <div class="container d-flex align-items-center flex-column ">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/escuela_de_aviacion.jpeg" alt="" />
                <img class="masthead-avatar mb-5" src="assets/img/escuela_de_aviacion.jpeg" alt="" />-->
                <!-- Masthead Heading
                <h1 class="masthead-heading text-uppercase mb-0">Escuela de Aviación</h1>-->
                <!-- Icon Divider-->
                <div class="divider-custom divider-light banner-styled">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon">Escuela de Aviación</div>
                    <div class="divider-custom-line"></div>
                </div>
                <!-- Masthead Subheading
                    ...
                    <div class="col-sm-6">
                        <div class="card p-xl-5">
                            <div class="card-body text-center">
                                <h5 class="card-title">Curso de Piloto</h5>
                                <p class="card-text">La licencia de piloto privado de avión con VFR
                                    controlado te permitirá volar monomotores de hasta 5.700 Kg de peso máximo de despegue.</p>
